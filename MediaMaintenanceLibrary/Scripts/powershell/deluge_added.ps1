...
$insertQuery = "INSERT INTO DownloadQueue ([pk_TorrentID], [TorrentName], [TorrentPath], [DownloadStarted], [TorrentStatus]) VALUES ('" + $torrentID + "', '" + $torrentName + "', '" + $torrentPath + "', '" + (Get-Date) + "', 'Downloading')"
